			...
			<div className="container pb-4">
				<div className="row">
					<div className="col-md text-center text-sm-start pt-sm-4">
						...
						<button className="px-5 py-3 bg-dark text-white fw-semibold">
							{" "}
							<IoIosArrowDroprightCircle className="fs-4" /> Visit Bantu Kraal
							Store
						</button>
					</div>
						...
						<div className="container">
							<div className="row">
								<div className="col-12 col-md-6">
									<img
										src={bIcon1}
										className="pb-4 w-100 img-fluid"
										alt="Image 1"
									/>
								</div>
								<div className="col-12 col-md-6">
								...
								<div className="col-12 col-md-6">
									<img src={bIcon4} className="w-100 img-fluid" alt="Image 4" />
								</div>
							</div>
						</div>
					</div>
