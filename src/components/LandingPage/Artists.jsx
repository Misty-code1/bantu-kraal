      ...
      <div className="container-fluid px-4">
        ...
        <div className="row mb-5">
          <div className="col-lg mb-5 mb-sm-0">
            <div class="coll">
              <img src={artist1} class="card-img-top" alt="..." />
              <div class="card-body d-flex text-center mt-3 mt-sm-4">
          ...
          <div className="col-lg mb-5 mb-sm-0">
            <div class="coll">
              <img src={artist2} class="card-img-top" alt="..." />
              <div class="card-body d-flex text-center mt-3 mt-sm-4">
                <div className="p-icon-div me-3 me-sm-4">
          ...
          <div className="col-lg mb-5 mb-sm-0">
            <div class="coll">
              <img src={artist3} class="card-img-top" alt="..." />
              <div class="card-body d-flex text-center mt-3 mt-sm-4">
                <div className="p-icon-div me-3 me-sm-4">
